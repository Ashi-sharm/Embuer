...
//     >
//       <div ref={containerRef} className="container mx-auto px-4 md:px-6 -ml-6">
...
//             className="relative w-screen h-[325px] md:h-[425px] lg:h-[525px] flex items-center justify-center overflow-hidden"
//           >
