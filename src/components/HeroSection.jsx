...
const HeroSection = () => {
  return (
    <section className="min-h-screen w-full overflow-hidden flex items-center">
      ...
      <div className="absolute bottom-0 left-0 w-screen bg-embuer-matcha text-gray-500 py-2 overflow-hidden">
  <div className="flex whitespace-nowrap animate-marquee">
    <span className="mr-10">🌿 100% Natural & Organic Ingredients</span>
    <span className="mr-10">🛡️ Dermatologically Tested & Safe for All Skin Types</span>
    <span className="mr-10">🌎 Eco-Friendly & Sustainable Packaging</span>
    <span className="mr-10">🚫 No Harsh Chemicals, Sulfates, or Parabens</span>
